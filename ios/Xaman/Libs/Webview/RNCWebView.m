...
- (void)didMoveToWindow
{
  if (self.window != nil && _webView == nil) {
    ...
    NSSet *clearCacheDataTypes = [NSSet setWithArray:@[WKWebsiteDataTypeDiskCache, WKWebsiteDataTypeMemoryCache, WKWebsiteDataTypeCookies ]];
    [_webView.configuration.websiteDataStore removeDataOfTypes:clearCacheDataTypes
