...
public class Hex {
   ...
   * @see #decodeHex(char[])
   */
  public static Object decode(Object object) throws RuntimeException {
    try {
  ...
  public static String encodeString(String arg, String charset) throws UnsupportedEncodingException {
