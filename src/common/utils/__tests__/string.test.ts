...
describe('Utils.String', () => {
    ...
    describe('StringTypeCheck', () => {
        ...
        it('should check if string is valid URL', () => {
            ...
            expect(StringTypeCheck.isValidURL({ someting: true } as any)).toBe(false);
            expect(StringTypeCheck.isValidURL(undefined as any)).toBe(false);
            expect(StringTypeCheck.isValidURL(null as any)).toBe(false);
            expect(StringTypeCheck.isValidURL('')).toBe(false);

            for (let i = 0; i < validUrls.length; i++) {
                expect(StringTypeCheck.isValidURL(validUrls[i] as any)).toBe(true);
            }
        ...
        it('should check if string is valid amount', () => {
            ...
            // @ts-ignore
            expect(StringTypeCheck.isValidAmount({ someting: true } as any)).toBe(false);
            expect(StringTypeCheck.isValidAmount(undefined as any)).toBe(false);
            expect(StringTypeCheck.isValidAmount(null as any)).toBe(false);
        ...
        it('should check if string is valid transaction hash', () => {
            // @ts-ignore
            expect(StringTypeCheck.isValidHash({ someting: true } as any)).toBe(false);
            expect(StringTypeCheck.isValidHash(undefined as any)).toBe(false);
            expect(StringTypeCheck.isValidHash(null as any)).toBe(false);
        ...
        it('should check if string is valid xApp Identifier', () => {
            // @ts-ignore
            expect(StringTypeCheck.isValidXAppIdentifier({ someting: true } as any)).toBe(false);
            expect(StringTypeCheck.isValidXAppIdentifier(undefined as any)).toBe(false);
            expect(StringTypeCheck.isValidXAppIdentifier(null as any)).toBe(false);
