import { Ledger, LedgerEntryFilter } from '../ledger';
...
export interface LedgerQueueData {
    account: string;
    tx: any | LedgerModifiedOfferCreateTransaction | { tx_blob: string };
...
export interface LedgerBinary extends Omit<Omit<Ledger, 'transactions'>, 'accountState'> {
    accountState?: string[];
    transactions?: string[];
}
