...
import { AMMWithdraw } from '@common/libs/ledger/transactions';
...
/* Component ==================================================================== */
class AMMWithdrawTemplate extends Component<Props, State> {
    ...
    render() {
        ...
        return (
            <>
                ...
                {!isUndefined(transaction.LPTokenIn) && (
                    <>
                        <Text style={styles.label}>{Localize.t('events.lpTokenIn')}</Text>
                        <View style={styles.contentBox}>
                            <AmountText
                                value={transaction.LPTokenIn.value}
                                currency={transaction.LPTokenIn.currency}
                                style={styles.amount}
                                immutable
                            />
                        </View>
...
export default AMMWithdrawTemplate;
