                ...
                <View style={AppStyles.flex8}>
                    <ScrollView style={[AppStyles.flex1, AppStyles.padding, AppStyles.paddingTopSml]}>
                        ...
                        <View style={styles.row}>
                            ...
                            {this.renderButton(
                                'TransactionType',
                                Localize.t(`global.${TransactionTypes.URIToken.toLowerCase()}`),
                                TransactionTypes.URIToken,
                            )}
                            {this.renderButton(
                                'TransactionType',
                                Localize.t(`global.${TransactionTypes.AMM.toLowerCase()}`),
                                TransactionTypes.AMM,
                            )}
                            {this.renderButton(
                                'TransactionType',
